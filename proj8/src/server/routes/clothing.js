...
module.exports = function (monitor) {
  ...
  router
    ...
    .post(async function (req, res) {
      try {
        // read existing clothing with getClothingData()
        let data = await getClothingData();
        // calculate next avaliable id with getNextAvailableID()
        ...
        // push clothing item to the array of existing clothing
        data.push(newClothingItem);
        // write the clothing aray to the clothing.json file with saveClothingData()
